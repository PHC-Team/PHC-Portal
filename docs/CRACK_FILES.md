...
PHC-Portal's **Fixes & Bypasses** feature fetches a curated game fix list from the CrakFiles repository on GitHub and downloads the selected fix directly into your game folder.
...
**Raw JSON (what PHC-Portal fetches):**
```
...
| Field | Type | Description |
|---|---|---|
| `href` | string | Download URL (buzzheavier.com). This is what PHC-Portal downloads. |
