...
PHC-Portal can search and apply game fixes and bypasses from a curated list hosted on GitHub.
...
3. PHC-Portal fetches the fix list and shows matches for your game first.
