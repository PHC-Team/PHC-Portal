...
PHC-Portal can download and apply HyperVisor bypasses for Denuvo-protected games via the **HV Auto** button on the Home tab. This guide explains what HV cracks are, the security trade-offs, and exactly how to use them.
...
## Step-by-Step: Using HV via PHC-Portal

**Prerequisites:** The game is already installed. PHC-Portal has applied the Lua/manifest fix.

1. Open PHC-Portal and go to the **Home** tab.
2. Select your game from the dropdown.
3. Click **HV Auto** (under Fixes/Bypasses).
4. PHC-Portal downloads and extracts the HV crack files into the game folder.
...
- **Use only approved VBS.cmd versions.** Do not use scripts from unknown sources. The one bundled by PHC-Portal is open source and reviewed.
...
**Does PHC-Portal download VBS.cmd?**
PHC-Portal downloads the full HV crack package for your game, which includes VBS.cmd. You do not need to find it separately.

**Does this work on every Denuvo game?**
HV cracks are game-specific. PHC-Portal only offers an HV download when a compatible release exists for your installed game version. If no release exists, the button will report no available bypass.
...
- Tutorial 1: https://www.youtube.com/watch?v=J9fVenXstAc
- Tutorial 2: https://www.youtube.com/watch?v=lyjVuDDEJfo
- PHC-Portal Discord: https://discord.gg/RNNg5TS7h5
