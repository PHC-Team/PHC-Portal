...
PHC-Portal helps you set up games to work with Steam using Lua scripts and manifests. It writes the right files into your Steam folder so games and DLCs can run. It does not replace or crack Steam itself.
...
### Just download the exe from [here](https://github.com/PHC-Team/PHC-Portal/releases/latest) and run it, no instalation required.
